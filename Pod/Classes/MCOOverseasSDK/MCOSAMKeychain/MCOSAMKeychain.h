...
extern NSString *const mcoKSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const mcokSAMKeychainAccountKey;
 ...
 */
extern NSString *const mcokSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const mcokSAMKeychainClassKey;

/** Item description. */
extern NSString *const mcokSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const mcokSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const mcokSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const mcokSAMKeychainWhereKey;
 ...
 */
@interface MCOSAMKeychain : NSObject
