 ...
 */
@interface MCOSAMKeychainQuery : NSObject

/** kSecAttrAccount */
@property (nonatomic, copy, nullable) NSString *mcoAccount;

/** kSecAttrService */
@property (nonatomic, copy, nullable) NSString *mcoService;

/** kSecAttrLabel */
@property (nonatomic, copy, nullable) NSString *mcoLabel;

#ifdef SAMKEYCHAIN_ACCESS_GROUP_AVAILABLE
/** kSecAttrAccessGroup (only used on iOS) */
@property (nonatomic, copy, nullable) NSString *mcoAccessGroup;
#endif

#ifdef SAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE
/** kSecAttrSynchronizable */
@property (nonatomic) SAMKeychainQuerySynchronizationMode mcoSynchronizationMode;
#endif

/** Root storage for password information */
@property (nonatomic, copy, nullable) NSData *mcoPasswordData;
